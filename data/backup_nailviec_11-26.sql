...
-- Dumping data for table reselleradmin_nailviec.jobs: 37 rows
DELETE FROM `jobs`;
INSERT INTO `jobs` (`Id`, `NailShopId`, `JobStatusId`, `Title`, `Body`, `PhoneContact`, `DateUpdated`, `Salary`) VALUES
	(1, 9, 2, 'Cần thợ bột và tay chân nước...', 'Tiệm ở vùng Clear Lake, khu Mỹ trắng, cần thợ bột và tay chân nước, bao lương hoặc ăn chia tùy theo khả năng.', 'Work: 281-480-4050 or Cell: 281-736-8579', '2016-11-19 09:12:34', 'thỏa thuận'),
	...
	(7, 7, 2, 'CẦN THỢ BỘT HOẶC TAY CHÂN NƯỚC', '', '281-785-8143 OR 281-469-5488', '2016-11-04 04:38:34', ''),
	(34, 2, 1, 'aaaa', 'bbbb', '1111', '2016-11-04 04:44:32', '121212'),
	(35, 2, 1, 'tạm thời', 'bbbb', '1111', '2016-11-04 04:44:32', '121212'),
	...
	(9, 10, 2, 'Cần Thợ Nailsaaa', 'Tiệm trong khu chợ Foodtown đối diện chợ Hồng Kông 2 (south 45 ) đang cần thợ. Full time hoặc part time. Bao lương Tuỳ theo khả năng. Tiệm đóng cửa chủ nhật. Chỗ làm thoải mái, vui vẻ.', '281-896-1075 or 281-481-9169', '2016-11-19 10:07:32', 'aaa'),
	...
	(27, 32, 2, 'Cáº§n thÆ¡ nails Nam nÆ°Ìƒ', 'Tiá»‡m khu má»… trÃªn Ä‘Æ°á»ng bellaire and chimney rock .Cáº§n thá»£ nails biáº¿t lÃ m bá»™t,chÃ¢n tay nÆ°Æ¡Ìc ,bao lÆ°Æ¡ng $700 tuáº§n. HoÄƒÌ£c Äƒn chia', '(713) 269-0414 (Gá»i Gáº·p: Tammy)', '2016-11-04 04:50:07', 'thỏa thuận nhe'),
	...
	(36, 1, 1, 'Cần tuyển', '12 nhân viên lao động thời vụ', '123453', '2016-11-04 04:53:32', 'thỏa thuận'),
	(37, 1, 1, 'This integration is done simply by including the DataTables Bootstrap files (CSS and JS) which will set the defaults needed for DataTables to be initialised as normal, as shown in this examples.', 'At times you will wish to be able to create a table from dynamic information passed directly to DataTables, rather than having it read from the document. This is achieved using the data option in the initialisation object, passing in an array of data to be used (like all other DataTables handled data, this can be arrays or objects using the columns.data option).', 'In addition to the above code, the following Javascript library files are loaded for use in this example:\n\n//code.jquery.com/jquery-1.12.3.js\nhttps://cdn.datatables.net/1.10.12/js/jquery.dataTables.min.js\nhttps://cdn.datatables.net/1.10.12/js/dataTables.bootstrap.min.js', '2016-11-19 10:39:07', '343434');
...
-- Dumping data for table reselleradmin_nailviec.nailshopowner: 25 rows
...
INSERT INTO `nailshopowner` (`Id`, `FullName`, `Phone`, `Email`, `Password`, `ShopOwnerStatusId`, `DateUpdated`) VALUES
	...
	(2, 'Sang 1A', '09874110', 'sang1a@gmail.com', '', 4, '2016-11-19 10:05:15'),
	...
	(25, 'TEst1', '0909090', 'sangnew2016@gmail.com', '', 1, '2016-11-19 10:05:42');
...
INSERT INTO `nailshops` (`Id`, `ShopName`, `AreaId`, `ShopAddress`, `Latitude`, `Longtitude`, `ShopStatusId`, `ShopOwnerId`, `DateUpdated`, `FileName`) VALUES
	(1, 'Vogue Nails', 1, '16925 El Camino Real Houston, TX - 77058', 29.553138, -95.118104, 1, 1, '2016-11-19 14:53:46', '_2016-11-19_14-53-46_403300_shop.png'),
	(2, 'Pretty Nails & Spa', 1, '1333 Old Spanish Trl Ste B Houston, TX - 77054', 29.694247, -95.412177, 1, 2, '2016-11-04 07:46:15', NULL),
	(3, 'Royal Nails & Spa', 1, '8505 S Main St Ste 300 Houston, TX - 77025', 29.690913, -95.415827, 2, 3, '2016-11-19 10:59:12', '_2016-11-19_10-59-12_112400_shop.png'),
	(4, 'Q Nails & Spa', 1, '2825 S Kirkwood Rd Houston, TX - 77082', 29.732266, -95.588779, 1, 4, '2016-11-04 12:55:14', '_2016-11-04_12-55-14_878000_shop.png'),
	(5, 'Diva Nails & Spa', 1, '19708 N.w Freeway Suite 600 Houston, TX - 77065', 29.915546, -95.612382, 1, 5, '2016-06-06 00:00:00', NULL),
	(6, 'Lily Nails By Sonny', 1, '9150 S Main St Houston, TX - 77025', 29.686008, -95.422029, 1, 0, '0000-00-00 00:00:00', NULL),
	(7, 'Fabulous Nails', 1, '11300 West Rd Houston, TX - 77065', 29.908672, -95.59162, 1, 0, '2016-06-01 00:00:00', NULL),
	(8, 'Lux Nails Spa', 1, '9668 Westheimer Rd, Suite 400 Houston, TX - 77063', 29.967265, -95.692769, 1, 0, '0000-00-00 00:00:00', NULL),
	(9, 'Pink Nail Lounge', 1, '1460 Eldridge Pkwy Houston, TX - 77077', 29.759116, -95.625988, 1, 0, '0000-00-00 00:00:00', NULL),
	(10, 'TLC Nails & Spa', 1, '10904 Scarsdale Blvd Suite 285 Houston, TX - 77089', 29.586275, -95.21101, 1, 0, '0000-00-00 00:00:00', NULL),
	(11, 'Kayla Nails', 1, '802 Rankin Rd Ste A3 Houston, TX - 77073', 29.965608, -95.398302, 1, 0, '0000-00-00 00:00:00', NULL),
	(12, 'Vintage Nails', 1, '10850 Louetta Rd Ste 400 Houston, TX - 77070', 29.997791, -95.575748, 1, 0, '0000-00-00 00:00:00', NULL),
	(13, 'Regal Nails', 1, '10919 Louetta Rd Ste 106 Houston, TX - 77070', 29.995369, -95.576223, 1, 0, '0000-00-00 00:00:00', NULL),
	(14, 'Heavenly Lashes Nail Spa', 1, '2007 W Alabama St Ste C Houston, TX - 77098', 29.738225, -95.408451, 1, 0, '0000-00-00 00:00:00', NULL),
	(15, 'Lexor Store', 1, '11209 Bellaire Blvd (Inside Hong Kong 4 Mall) Houston, TX - 77072', 29.701814, -95.577366, 1, 0, '0000-00-00 00:00:00', NULL),
	(16, 'Dk Nail', 1, '8615 Tidwell F Houston, TX - 77028', 29.850429, -95.264439, 1, 0, '0000-00-00 00:00:00', NULL),
	(17, 'Soho Nail Louge', 1, '9738 Katy Fwy Houston, TX - 77055', 29.786263, -95.533688, 1, 0, '0000-00-00 00:00:00', NULL),
	(18, 'Texan Nails', 1, '6830 E Sam Houston Pk N Houston, TX - 77049', 29.867452, -95.56342, 1, 0, '0000-00-00 00:00:00', NULL),
	(19, 'Herbal Nails And Spa', 1, '11510 Space Center Blvd Ste C Houston, TX - 77059', 29.624504, -95.140604, 1, 0, '0000-00-00 00:00:00', NULL),
	(20, 'Regal Nails', 1, '3506 Highway 6 S Houston, TX - 77082', 29.721232, -95.64723, 1, 0, '0000-00-00 00:00:00', NULL),
	(21, '9 Hair-nails & Spa', 1, '8906 Airport Blvd St Ste C Houston, TX - 77061', 29.573457, -95.085218, 1, 0, '0000-00-00 00:00:00', NULL),
	(22, 'Eternity Nails', 1, '3821 Bellaire Blvd Houston, TX - 77025', 29.705433, -95.4399867, 1, 0, '0000-00-00 00:00:00', NULL),
	(23, 'Nails Couture', 1, '10511 Jones Rd Houston, TX - 77065', 29.925639, -95.585352, 1, 0, '0000-00-00 00:00:00', NULL),
	(24, 'Season’s Of Nails & Skin Care', 1, '9025 Westheimer Rd\r\nHouston, TX - 77063', 29.736903, -95.523514, 1, 0, '0000-00-00 00:00:00', NULL),
	(25, 'Borgata Nail Salon', 1, '2626 Yale St Houston, TX - 77008', 29.811052, -95.398839, 1, 0, '0000-00-00 00:00:00', NULL),
	(26, 'Resort Nail and Spa', 1, '2520 Rice Blvd Houston, TX - 77005', 29.717545, -95.41713, 1, 0, '0000-00-00 00:00:00', NULL),
	(27, 'Cabana Day Spa', 1, '1031 Blalock Rd Houston, TX - 77055', 29.7864, -95.52166, 1, 0, '0000-00-00 00:00:00', NULL),
	(28, 'Sunshine Nails', 1, '15754 Fm 529 Rd Ste 400 Houston, TX - 77095', 29.879883, -95.647972, 1, 0, '0000-00-00 00:00:00', NULL),
	(29, 'Signature Nail Spa', 1, '6915 Fm 1960 West Houston, TX - 77069', 29.96917, -95.532129, 1, 0, '0000-00-00 00:00:00', NULL),
	(30, 'Adagio\'s Nails & Spa', 1, '2200 Spears Rd Houston, TX - 77067', 29.965017, -95.45287, 1, 0, '0000-00-00 00:00:00', NULL),
	(31, 'Dazzle Nails And Spa', 1, '10555 Pearland Pkwy Houston, TX - 77089', 29.597803, -95.265227, 1, 0, '0000-00-00 00:00:00', NULL),
	(32, 'Cn Nail', 1, '5800 Bellaire Boulevard Houston, TX - 77081', 29.706638, -95.483934, 1, 0, '0000-00-00 00:00:00', NULL),
	(33, 'VIP Nails Vintage Spa', 1, '10220 Louetta Rd Ste 500 Houston, TX - 77070', 29.998961, -95.564312, 1, 0, '0000-00-00 00:00:00', NULL),
	(34, 'Lux Nails & Spa', 1, '9668 Westheimer Rd, Suite 400 Houston, TX - 77063', 29.967301, -95.692734, 1, 0, '0000-00-00 00:00:00', NULL),
	(35, 'Vip Nails Spa', 1, '12344 Gulf Fwy Houston, TX - 77034', 29.618486, -95.21924, 1, 0, '0000-00-00 00:00:00', NULL),
	(36, 'Rose Nails', 1, '734 Greens Rd Houston, TX - 77060', 29.950506, -95.398161, 1, 0, '0000-00-00 00:00:00', NULL),
	(37, 'Nails 45south', 1, '15327 Gulf Fwy Houston Houston, TX - 77034', 29.698888, -95.285423, 1, 0, '0000-00-00 00:00:00', NULL),
	(38, 'Cindys Nails', 1, '210 W Greens Rd Ste F Houston, TX - 77067', 29.950026, -95.419467, 1, 0, '0000-00-00 00:00:00', NULL),
	(39, 'Palace Nail Spa', 1, '8498 S Sam Houston Pkwy E Houston, TX - 77075', 29.598671, -95.266957, 1, 0, '0000-00-00 00:00:00', NULL),
	(40, 'Airjet Spa', 1, '550 Heights Blvd Ste A Houston, TX - 77007', 29.781159, -95.397041, 1, 0, '0000-00-00 00:00:00', NULL),
	(41, 'Nails By D&K', 1, '8615 Tidwell, Suite F Houston, TX - 77028', 29.849632, -95.271009, 1, 0, '0000-00-00 00:00:00', NULL);
...
-- Dumping data for table reselleradmin_nailviec.shopstatus: ~2 rows (approximately)
