...
;(function ($) {
    ...
    Metis.OwnerShop = function () {
        ...
        function setRule() {
            ...
            rule[config.model.fullName] = "required", rule[config.model.phone] = "required", rule[config.model.email] = {
                required: true,
                email: true
        ...
        function onSubmitHandler(form) {
            ...
            function getPostedShopOwnerInput() {
                var param = {};
                param[config.model.id] = Metis.OwnerShop.Id || 0, param[config.model.fullName] = document.getElementById(config.model.fullName).value, param[config.model.phone] = document.getElementById(config.model.phone).value, param[config.model.email] = document.getElementById(config.model.email).value, param[config.model.status] = config.defaultStatusId, param[config.model.password] = document.getElementById(config.model.password).value, param[config.model.confirmPassword] = document.getElementById(config.model.confirmPassword).value;
