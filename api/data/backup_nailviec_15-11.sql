...
-- Dumping data for table reselleradmin_nailviec.jobs: 36 rows
DELETE FROM `jobs`;
/*!40000 ALTER TABLE `jobs` DISABLE KEYS */;
INSERT INTO `jobs` (`Id`, `NailShopId`, `JobStatusId`, `Title`, `Body`, `PhoneContact`, `DateUpdated`, `Salary`) VALUES
	(1, 1, 2, 'Cần thợ bột và tay chân nước...', 'Tiệm ở vùng Clear Lake, khu Mỹ trắng, cần thợ bột và tay chân nước, bao lương hoặc ăn chia tùy theo khả năng.', 'Work: 281-480-4050 or Cell: 281-736-8579', '2016-11-04 05:06:04', 'thỏa thuận'),
...
INSERT INTO `nailshops` (`Id`, `ShopName`, `AreaId`, `ShopAddress`, `Latitude`, `Longtitude`, `ShopStatusId`, `ShopOwnerId`, `DateUpdated`, `FileName`) VALUES
	(1, 'Vogue Nails', 1, '16925 El Camino Real Houston, TX - 77058', 29.553138, -95.118104, 1, 1, '2016-11-04 07:47:07', NULL),
	(2, 'Pretty Nails & Spa', 1, '1333 Old Spanish Trl Ste B Houston, TX - 77054', 29.694247, -95.412177, 1, 2, '2016-11-04 07:46:15', NULL),
	(3, 'Royal Nails & Spa', 1, '8505 S Main St Ste 300 Houston, TX - 77025', 29.690913, -95.415827, 1, 3, '2016-11-04 12:53:20', '_2016-11-04_12-53-20_427000_shop.png'),
...
-- Dumping database structure for secure_login
DROP DATABASE IF EXISTS `secure_login`;
CREATE DATABASE IF NOT EXISTS `secure_login` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `secure_login`;

-- Dumping structure for table secure_login.login_attempts
...
-- Dumping data for table secure_login.login_attempts: ~2 rows (approximately)
...
-- Dumping structure for table secure_login.members
...
-- Dumping data for table secure_login.members: ~1 rows (approximately)
DELETE FROM `members`;
